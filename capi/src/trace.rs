...
pub struct blaze_trace_lvl(c_int);

pub const BLAZE_LVL_DEBUG: blaze_trace_lvl = blaze_trace_lvl(1);
pub const BLAZE_LVL_INFO: blaze_trace_lvl = blaze_trace_lvl(2);
pub const BLAZE_LVL_TRACE: blaze_trace_lvl = blaze_trace_lvl(3);
pub const BLAZE_LVL_WARN: blaze_trace_lvl = blaze_trace_lvl(4);


impl From<blaze_trace_lvl> for LevelFilter {
    fn from(other: blaze_trace_lvl) -> Self {
        match other {
            BLAZE_LVL_WARN => LevelFilter::WARN,
            BLAZE_LVL_INFO => LevelFilter::INFO,
            BLAZE_LVL_DEBUG => LevelFilter::DEBUG,
            BLAZE_LVL_TRACE => LevelFilter::TRACE,
            _ => LevelFilter::TRACE,
        }
    }
}
...
///
///  The provided [`blaze_trace_lvl`] determines
///
